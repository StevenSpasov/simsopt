...
def optimize(
    ...
    base_tf_curves, base_tf_currents = generate_tf_array(
        ...
        TF_a=TF_a,
        TF_b=TF_b,
        fixed_geo_tfs=False, # make sure this parameter is false (or it will give you an error)
    ...
    # add later if you want to try stage 2 optimization
    ...
    # do this if you want, not super important
    ...
    # IF THIS LINE GIVES AN ERROR, CHECK MAIN SIMSOPT EXAMPLES 
    # simplest case is probably curves_to_vtk(curves, filename)
    curves_to_vtk(
